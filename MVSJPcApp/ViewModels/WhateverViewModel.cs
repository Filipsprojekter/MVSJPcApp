...
namespace MVSJPcApp.ViewModels
{
    class WhateverViewModel : INotifyPropertyChanged
    {
        ...
        public static ObservableCollection<User> ÅtilAUserList { get; set; }
        ...
        public WhateverViewModel()
        {
            ...
            ////User user1 = new User("Køge","Beredskab","adolf","wrx55555");
            ////User user2 = new User("Roskilde", "Beredskab", "Dame", "Wrx12345");
            ////User user3 = new User("Ringsted", "Beredskab", "Egon", "Wrx12341");
            ////User user4 = new User("Kalundborg", "Beredskab", "Bodil", "Wrx12342");
            ////User user5 = new User("Køge", "Beredskab", "Cecil", "Wrx12343");
            ////User user6 = new User("Køge", "Beredskab", "Filip", "Wrx12344");
            ...
            KøgeListe = new ObservableCollection<User>();
           ...
           ÅtilAUserList = new ObservableCollection<User>(UserList.OrderByDescending(x => x.Navn).ToList());
        }
